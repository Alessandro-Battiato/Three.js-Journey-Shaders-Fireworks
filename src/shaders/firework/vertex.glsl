...
void main() {
    ...
    // Final particle size
    gl_PointSize = uSize * uResolution.y * aSize * sizeProgress; // fix particles size according to vertical FOV so it scales if window is resized vertically (not horizontally)
